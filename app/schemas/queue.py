...
class JobStatusResponse(BaseModel):
    ...
    status: str = Field(..., json_schema_extra={"example": "completed"}, description="Job status: queued, processing, completed, failed")
    result: Optional[ImageExtractionResponse] = Field(None, description="Final extracted places JSON if status == completed")
